-- ELOS — "Atividade recente" do admin mostrava só as últimas 30 linhas no
-- geral (podendo ficar velho de vários dias se o app estivesse parado, ou
-- cortar atividade de hoje se tivesse muito volume). Agora mostra TODAS as
-- atividades das últimas 24h, sem limite artificial baixo — o teto alto é só
-- uma proteção técnica, não uma paginação de verdade.
